...
function App() {
    ...
    <div className="App">
        <pre>
            ...
            <div><span className="param">  age</span>: <span className="number">30</span>,</div>
            ...
            <div>    <span className="string">'HTML'</span>, <span className="string">'CSS'</span>, <span className="string">'Pug'</span>, <span className="string">'Docker'</span>, <span className="string">'MobX'</span>,</div>
            <div>    <span className="string">'SASS'</span>, <span className="string">'Redux Toolkit'</span>, <span className="string">'PostgreSQL'</span>,</div>
            <div>    <span className="string">'Webpack'</span>, <span className="string">'GIT'</span>, <span className="string">'Figma'</span>, <span className="string">'Node.js'</span>,</div>
            <div>    <span className="string">'Express'</span>, <span className="string">'Next.js'</span>, <span className="string">'Sequelize'</span></div>
            <div>    <span className="string">'Storybook'</span></div>
            <div>  ],</div>
            <br/>
            <div><span className="param">  familiarWith</span>: [</div>
            <div>    <span className="string">'Nest.js'</span>,</div>
            <div>    <span className="string">'Ubuntu Linux'</span>,</div>
            <div>    <span className="string">'Nginx'</span>,</div>
            <div>    <span className="string">'C'</span>,</div>
            <div>    <span className="string">'Jest'</span>,</div>
            <div>    <span className="string">'CI/CD'</span></div>
            <div>  ],</div>
            <br/>
            ...
            <div>    <span className="string">'Curiosity'</span>, <span className="string">'Self-learning'</span></div>
            <div>  ],</div>
            <br/>
            ...
            <div>    <span className="string">'Full-stack Developer'</span>,</div>
            <div>  ],</div>
            <br/>
